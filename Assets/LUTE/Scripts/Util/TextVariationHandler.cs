// Derived from Fungus TextVariationHandler.cs (under MIT open source license) (https://github.com/snozbot/fungus)
...
namespace LoGaCulture.LUTE
{
    ...
    public static class TextVariationHandler
    {
        ...
        static public bool TokeniseVarySections(string input, List<Section> varyingSections)
        {
        ...
        {
            //Match regular expression pattern against text string
            ...
            for (int i = 0; i < sections.Count; i++)
            {
                ...
                //Input and entire section can be same so we can shuffle around using XOR shifting
