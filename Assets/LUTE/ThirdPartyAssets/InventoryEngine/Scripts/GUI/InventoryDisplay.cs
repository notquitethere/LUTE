...
namespace MoreMountains.InventoryEngine
{
    ...
    {
        [SerializeField] protected InventoryInputManager inventoryInputManager;
        ...
        protected virtual void UpdateSlot(int i)
        {
            ...
            if (!InventoryItem.IsNull(TargetInventory.Content[i]))
            {
                ...
                SlotContainer[i].SetNameText(TargetInventory.Content[i], i);
            }
            else
            {
                SlotContainer[i].DrawIcon(null, i);
                SlotContainer[i].SetNameText(null, i);
            }
        }
        ...
        protected virtual void DrawSlot(int i)
        {
            ...
            theSlot.onClick.AddListener(() =>
            {
                if (inventoryInputManager != null)
                {
                    inventoryInputManager.EquipOrUse();
                }
            });
            ...
            theSlot.SetNameText(TargetInventory.Content[i], i);
        }
